            ...
            <div className="row g-0 align-items-center">
                    ...
                    <div className="furniture-rating__left-item">
                        <div className="furniture-ad__item frl-item bg-furniture">
                            <div className="fad-content">
                                ...
                                <h2 className="text-capitalize text-white">Live Furniture <br />
                                    Your Love</h2>
                                <a className="border__btn-f mt-35 bg-white text-black" href="product-details.html">Buy Now<span><i className="fa-regular fa-angle-right" /></span></a>
                            </div>
                        </div>
                    </div>
                </div>
                <div className="col-xl-6">
                    <div className="furniture-rating__right-item">
                        <img className="w-100" src="/imgs/furniture/rating/bg-image.png" alt="image" />
...
export default Rattingareastart;
